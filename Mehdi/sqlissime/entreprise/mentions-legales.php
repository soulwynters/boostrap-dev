<?php
	...
	$page_name="Mentions l&eacute;gales";
?>
<!DOCTYPE HTML>
<html>
	<head>
						...
						<div id="content" class="8u skel-cell-important">
							<section>
								<header class="major">
									...
									<span class="byline">Notice l&eacute;gale du site SQLissime.com</span>
								</header>
								<p>
									...
									soci&eacute;t&eacute;s de Versailles sous le num&eacute;ro 513 946 020 00023, dont le si&egrave;ge social est situ&eacute; au 32 Avenue de la Constellation, 
									95800 Cergy.<br />
									<br />
