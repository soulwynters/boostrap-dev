<?php
	...
	$page_name="D&eacute;veloppement";
?>
<!DOCTYPE HTML>
<html>
	<head>
				...
				<div class="container">
					<div class="row">
						...
						<div id="content" class="8u skel-cell-important">
							<section>
								<header class="major">
									<h1 style="margin: 0;padding: 0;font-size: 3em;font-weight: 600;">D&eacute;veloppement</h1>
									<span class="byline">Page en construction</span>
								</header>
								<h2>Applications sur environnements distribu&eacute;s</h2>
								<p>
